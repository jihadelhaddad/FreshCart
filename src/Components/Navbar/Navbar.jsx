          ...
          <ul className="navbar-nav ms-auto mt-2 mt-lg-0">
            {userToken !== null ? (
              <>
                ...
                <ul>
                  <li>
                    <a href="https://www.facebook.com/jii.had.562/" target="_blank">
                      <i className="fa-brands fa-facebook text-dark mt-3 pe-3 border-0 "></i>
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/jihadelhaddad" target="_blank">
                      <i className="fa-brands fa-github text-dark mt-3 pe-3 "></i>
                    </a>
                  </li>
                  <li>
                    <a href="https://www.linkedin.com/in/jihad-elhaddad-b895882a5/" target="_blank">
